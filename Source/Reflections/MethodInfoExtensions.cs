...
namespace Reflections
{
    public static class MethodInfoExtensions
    {
        public static bool IsAutoGenerated(this MethodInfo element)
        {
            ...
            return MemoizedIsAutoGenerated(element);
        }
        ...
        public static bool IsOverride(this MethodInfo element)
        {
            ...
            return MemoizedIsOverride(element);
        }
        ...
        private static readonly Func<MethodInfo, bool> MemoizedIsAutoGenerated = ((Func<MethodInfo, bool>)(element => element.GetCustomAttributes<CompilerGeneratedAttribute>(true).Any())).Memoize(true);

        private static readonly Func<MethodInfo, bool> MemoizedIsOverride = ((Func<MethodInfo, bool>)(element =>
            {
